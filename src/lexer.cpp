...
Token Lexer::nextToken() {
    ...
    default:
        if (isalpha(static_cast<unsigned char>(c)) || c == '_') {
            ...
            if (ident == "ret") return makeToken(TOKEN_RET, "ret", tokenLine, tokenCol);
            ...
            if (ident == "or") return makeToken(TOKEN_OR, "or", tokenLine, tokenCol);
            if (ident == "and") return makeToken(TOKEN_AND, "and", tokenLine, tokenCol);
            ...
            if (ident == "end") return makeToken(TOKEN_END, "end", tokenLine, tokenCol);
